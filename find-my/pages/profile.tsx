  ...
  return (
    <div className="py-10 px-4">
      ...
      <div className="grid grid-cols-3 gap-2 p-2 border-b ">
        <button className="text-center text-white bg-gray-400 p-2 focus:outline-none focus:ring-2 focus:ring-offset-2  focus:bg-blue-400">
          <span>찾고 있는 물건</span>
        </button>
        <button className="text-center text-white bg-gray-400 p-2 focus:outline-none focus:ring-2 focus:ring-offset-2  focus:bg-blue-400 ">
          <span>주인을 찾아요</span>
